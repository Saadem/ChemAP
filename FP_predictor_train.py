...
def main():
    ...
    print(f"Répertoire de sauvegarde créé : {model_save_dir}")
    ...
    print("Chargement du modèle enseignant préentraîné...")
    ...
    print("Initialisation du modèle étudiant...")
    ...
    print("Configuration de l’optimiseur et des fonctions de perte...")
    ...
    print("Début de l'entraînement du modèle étudiant...")
    best_val_auc = 0.0
    patience = 0
    for epoch in range(arg.epochs):
        print(f"\nÉpoque {epoch + 1}/{arg.epochs}")
        fp_student.train()
        teacher_model.eval()
        ...
        with torch.no_grad():
            ...
            if val_auc > best_val_auc:
                ...
                patience += 1
                print(f"AUC non améliorée. Patience : {patience}/20")

            if patience >= 20:
                print("⏹️ Arrêt anticipé (early stopping).")
                break
